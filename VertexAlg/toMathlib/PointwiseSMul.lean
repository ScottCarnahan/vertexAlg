...
public import VertexAlg.toMathlib.SMulAntidiagonal
...
theorem Set.SMulAntidiagonal.finite_of_finite_fst [SMul G P] [IsLeftCancelSMul G P] {s : Set G}
     (hs : s.Finite) (t : Set P) (p : P) :
